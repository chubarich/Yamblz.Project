...
public class AddCityRepositoryTest {
    ...
    public void setUp() {
        ...
        addCityRepository = new AddCityRepositoryImpl(dbHelper, preferenceHelper);
    ...
    public void getCitiesMatches_success() {
        ...
        addCityRepository.getCitiesMatches("city", Language.ENG)
                .test()
                .assertNoErrors()
                .assertComplete()
    ...
    public void saveCity_test() {
        ...
        addCityRepository.saveCity(cityDataModel)
